...
echo "       mysql -u root -p -e \"CREATE DATABASE sangia_scieco CHARACTER SET utf8mb4;\""
echo ""
echo "  3. Jalankan migrasi database:"
echo "       mysql -u root -p sangia_scieco < database/database_schema_full.sql"
echo "       mysql -u root -p sangia_scieco < database/migrations/database_migration_v2.sql"
echo ""
